 ...
 * clase estándar que deriva de adapter sirve para listar el historial de los elementos comprados
 */
class AdapterListHistory(val context: Context): RecyclerView.Adapter<AdapterListHistory.Viewholder>() {
    ...
    inner class Viewholder(view: View): RecyclerView.ViewHolder(view){
        ...
        fun bindItems(data: Element){
            ...
            tvDate.text = data.lastDatePurchased
